<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fi_summary.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="bbq.fi_summary" EnableEventValidation="false" %>
                ...
                <div class="sidebar-wrapper active">
                    ...
                    <div class="sidebar-menu">
                        <ul class="menu">
                            ...
                            <li
                                class="sidebar-item active has-sub" id="menu_reports" runat="server">
                                <a href="#" class='sidebar-link'>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <div class="form-group">
                                                    <asp:DropDownList CssClass="form-control" ID="month_drop" runat="server"   BorderColor="#3399ff">
                                                    </asp:DropDownList>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <asp:DropDownList CssClass="form-control" ID="report_type" runat="server"  BorderColor="#3399ff">
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <asp:Button ID="Button2" CssClass="btn btn-primary pull-right" runat="server" Text="Load PDF" OnClick="Button4_Click" AutoPostBack="False" />

                                                </div>
                                                <div class="form-group">
                                                    <asp:Button ID="Button1" CssClass="btn btn-primary pull-right" runat="server" Text="Load Report" OnClick="Button1_Click2" AutoPostBack="False" />
