<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="account_create.aspx.cs" Inherits="bbq.account_create" MaintainScrollPositionOnPostback="true" %>
                            ...
                            <div class="row">
                                <div class="card">
                                    <div class="card-header card-header-primary">
                                        <h4 class="card-title">Main Account Create</h4>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <asp:DropDownList CssClass="form-control" ID="list_account_type" runat="server" OnSelectedIndexChanged="account_type_SelectedIndexChanged" AutoPostBack="True" BorderColor="#3399ff">
                                                            <asp:ListItem>Bank Account</asp:ListItem>
                                                            <asp:ListItem Selected="True">Other Account</asp:ListItem>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox CssClass="form-control" ID="account_name" runat="server" BorderColor="#3399ff"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div id="panel_accounts" runat="server">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label>Currency Type</label>
                                                        <div class="form-group">
                                                            <asp:DropDownList CssClass="form-control" ID="list_currency" runat="server"  BorderColor="#3399ff">
                                                                <asp:ListItem Selected="True">LKR</asp:ListItem>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <asp:TextBox TextMode="Number" min="1" CssClass="form-control" ID="account_number" runat="server" BorderColor="#3399ff"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div id="Div1" class="row" runat="server">
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <asp:TextBox TextMode="Number" min="1" CssClass="form-control" ID="bank_code" runat="server" BorderColor="#3399ff"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div id="Div2" class="row" runat="server">
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <asp:TextBox TextMode="Number" min="1" CssClass="form-control" ID="branch_code" runat="server" BorderColor="#3399ff"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="card">
                                    <div class="card-header">
                                        <a style="color: #ff6a00">Main Account's List</a>
