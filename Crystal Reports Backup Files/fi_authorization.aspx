<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fi_authorization.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="bbq.fi_authorization" EnableEventValidation="false" %>
                ...
                <div class="sidebar-wrapper active">
                    ...
                    <div class="sidebar-menu">
                        <ul class="menu">
                            ...
                            <li
                                class="sidebar-item active has-sub" id="menu_authorization" runat="server">
                                <a href="#" class='sidebar-link'>
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div>
                                                    Reason For Reject :
                                                                    <asp:TextBox runat="server" min="1" ID="reason" CssClass="form-control"> </asp:TextBox>
                                                </div>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <asp:Button runat="server" OnClick="Unnamed_Click" CssClass="btn btn-primary ml-1" Text="Reject Selected Entries" />
                                        ...
                                        <asp:GridView ID="table1" runat="server" AutoGenerateColumns="true"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField ItemStyle-Width="10px">
                                                    <ItemTemplate>
                                                        <asp:LinkButton data-bs-toggle="modal"
                                                            data-bs-target="#default" ID="LinkButton3" Text="Reject" runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField ItemStyle-Width="10px">
                                                    <ItemTemplate>
