...
namespace bbq
{
    public partial class advance_reports : System.Web.UI.Page
    {
   ...
   WebConfigurationManager.ConnectionStrings["conn"].ConnectionString);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                list_typeReportOT.Items.Add("OverTime ( Selected Month )");
                list_typeReportOT.Items.Add("OverTime ( Audit )");
                list_typeReportOT.Items.Add("WorkHours ( Selected Month )");
                list_typeReportOT.Items.Add("WorkHours ( Audit )")
;
            }
            else
            {
