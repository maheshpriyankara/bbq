<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="onboarding.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="bbq.onboarding" EnableEventValidation="true" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function loadJobList2() {
            ...
            $.ajax({
                url: "https://localhost:44341/api/Job/getOnboardingList",
                type: "GET",
                success: function (data_) {
                    ...
                    function createAssignButton() {
                        ...
                        var assignButton = $("<button>").text("OnBoard").attr("class", "btn btn-success btn-rounded btn-sm");

                        assignButton.click(function () {
                            var value = $(this).closest("tr").find("td:first").text();
                            if (confirm("Are you sure you want to Onboard Selected Applicant?")) {
                                $(this).closest("tr").remove();
                                $.ajax({
                                    beforeSend: function () {
                                        $("#loading").css("visibility", "visible");
                                    },
                                    url: "https://localhost:44341/api/Job/UpdateOnboarding?id=" + value,
                                    type: "DELETE",
                                    success: function (data) {
                                        alert("Selected Applicant Onboarded Successfully");
                                    },
                                    complete: function () {
                    ...
                    function downloadCV() {
                        $.ajax({
                            ...
                            url: "https://localhost:44341/api/Export/öpencv?period=2023/May",
                            xhrFields: {
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-openable active">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="onboarding.aspx"><span class="fa fa-square-o"></span>Onboarding</a></li>
                        </ul>
                    </li>
                    <li class="xn-openable">
                        ...
                        <div class="col-md-14">
                            ...
                            <div class="block">
                                ...
                                <div class="col-md-12" id="panel_applicantist" runat="server">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Selected Candidate's</h3>
                                        </div>
