...
<head>
    ...
    <script type="text/javascript">
        function loadAttMonth(epfno, empState) {
            $.ajax({
                url: "https://localhost:44341/api/attendance/getattmonth?empname=" + epfno + "&year=" + document.getElementById('date_search').value + "&month=" + document.getElementById('list_month').value + "&empid=" + document.getElementById('text_attendanceId').value,
                            ...
                            extraOTInput.on("change", function () {
                                ...
                                if (regex24.test(value)) {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (data) {
                                            $.ajax({
                                                url: "https://localhost:44341/api/ProcessSalary/PushEmployee?epfno=" + epfno + "&period=" + document.getElementById('date_search').value + "/" + document.getElementById('list_month').value + "&requestFrom=Manual Attendance&user_=_&ip=_" + "&empid=" + document.getElementById('text_attendanceId').value,
                                                type: "PUT",
                                                success: function (data) {
                                                    $("#loading").css("visibility", "hidden");
                                                }
    ...
    <script type="text/javascript">
        function loadAttMonthProcessing(epfno) {
            $.ajax({
                url: "https://localhost:44341/api/attendance/GetAttMonthProcessing?empname=" + epfno + "&year=" + document.getElementById('date_search').value + "&month=" + document.getElementById('list_month').value + "&empid=" + document.getElementById('text_attendanceId').value,
                            ...
                            <div class="block">
                                ...
                                <div class="col-md-1">
                                    <div class="form-group has-success">
                                        ...
                                        <asp:Button ID="Previous" runat="server" Text="Previous" CssClass="form-control" BackColor="#ff9900" ForeColor="White" Font-Bold="true"></asp:Button>
                                        <script>
                                            ...
                                            function myMethod2() {
                                                ...
                                                $.ajax({
                                                    ...
                                                    url: "https://localhost:44341/api/EmployeeState/getempstate?epfno=" + document.getElementById('text_epfNo_').value + "&mode=false&year=" + document.getElementById('date_search').value + "&month=" + document.getElementById('list_month').value + "&empid=" + document.getElementById('text_attendanceId').value,

                                                    success: function (data) {
                                                        $.ajax({
                                                            type: "POST",
                                                            url: "attendance.aspx/employeeSelected",
                                                            data: "{'empName':'" + data + "','year':'" + document.getElementById('date_search').value + "','month':'" + document.getElementById('list_month').value + "'}",
                                                            contentType: "application/json; charset=utf-8",
                                                            dataType: "json",
                                                            success: function (data) {
                                                                var table2 = $("#table2 tbody");
                                ...
                                <div class="col-md-1">
                                    <div class="form-group has-success">
                                        <label class="control-label">.</label>
                                        <asp:Button ID="Next" runat="server" Text="Next" CssClass="form-control" BackColor="#009933" ForeColor="White" Font-Bold="true"></asp:Button>
                                        <script type="text/javascript">
                                            ...
                                            function myMethod() {
                                                ...
                                                $.ajax({
                                                    ...
                                                    url: "https://localhost:44341/api/EmployeeState/getempstate?epfno=" + document.getElementById('text_epfNo_').value + "&mode=true&year=" + document.getElementById('date_search').value + "&month=" + document.getElementById('list_month').value + "&empid=" + document.getElementById('text_attendanceId').value,
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            function myMethod3() {
                                                $.ajax({
                                                    ...
                                                    url: "https://localhost:44341/api/ProcessSalary/CheckEmployee?epfno=" + document.getElementById('text_epfNo_').value + "&period=" + document.getElementById('date_search').value + "/" + document.getElementById('list_month').value + "&empid=" + document.getElementById('text_attendanceId').value,
                                                                    ...
                                                                    if (data != 1) {
                                                                        $.ajax({
                                                                            ...
                                                                            success: function (data) {
                                                                                ...
                                                                                loadAttRow(empname);
                                                                                $.ajax({
                                                                                    url: "https://localhost:44341/api/ProcessSalary/PushEmployee?epfno=" + empname + "&period=" + document.getElementById('date_search').value + "/" + document.getElementById('list_month').value + "&requestFrom=Manual Attendance&user_=_&ip=_" + "&empid=" + document.getElementById('text_attendanceId').value,
                                                                                    type: "PUT",
                                                                                    success: function (data) {
