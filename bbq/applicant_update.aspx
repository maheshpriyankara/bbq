<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="applicant_update.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="bbq.applicant_update" EnableEventValidation="false" %>
                                ...
                                <div class="col-md-6">
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Update / Add Aplcant Profile</h3>
                                        </div>
                                        ...
                                        <div class="panel-body ">
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <asp:TextBox ID="text_applicantName" runat="server" CssClass="form-control" > </asp:TextBox>
                                            </div>
                                            <div class="form-group has-success">
                                                <label class="control-label">CV Update</label>
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <asp:DropDownList class="form-control" ID="list_category" runat="server" Font-Size="Small" AutoPostBack="true" OnSelectedIndexChanged="list_jobcategory_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </div>
                                            <div class="form-group has-success">
                                        ...
                                        <div class="panel-footer">
                                            <asp:Button ID="btn_save" class="btn btn-primary pull-right" Text="Update Profile" runat="server" OnClick="btn_save_Click1" />
                                        </div>
                                    </div>
                                </div>
