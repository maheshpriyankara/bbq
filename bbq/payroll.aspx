                ...
                success: function (data) {
                    if (data.d == '') {
                        ...
                        $.ajax({
                            ...
                            url: "https://localhost:44341/api/ProcessSalary/CheckEmployee?epfno=" + result[0] + "&period=" + document.getElementById('date_search').value + "/" + document.getElementById('list_month').value + "&empid=" + document.getElementById('text_attendanceId').value,
                                    ...
                                    <div class="panel-body ">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-6 col-xs-12 control-label">Cases Allowance</label>
                                                    <div class="col-md-6 col-xs-12">
